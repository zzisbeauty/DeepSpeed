...
from examples.dschats.dschat.utils.data.data_utils import create_prompt_dataset
from examples.dschats.dschat.utils.utils import \
    print_rank_0, to_device, save_hf_format, set_random_seed, get_all_reduce_mean, get_optimizer_grouped_parameters, save_zero_three_model, load_hf_tokenizer
from examples.dschats.dschat.utils.ds_utils import get_train_ds_config
from examples.dschats.dschat.utils.module.lora import \
    convert_linear_layer_to_lora, convert_lora_to_linear_layer, only_optimize_lora_parameters, make_model_gradient_checkpointing_compatible
from examples.dschats.dschat.utils.model.model_utils import create_hf_model, causal_lm_model_to_fp32_loss
from examples.dschats.dschat.utils.perf import print_throughput
...
def parse_args():
    ...
    parser.add_argument(
        '--data_output_path',
        type=str,
        default='/home/fzm/Desktop/DeepSpeedExamples/output/data_files',
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="If dropout configured, use it. Otherwise, keep the default dropout configuration of the model.")
    # deepspeed features
